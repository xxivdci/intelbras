window.onload = function () {
    (() => {
            ...
            "packages/shared/render/plugins/BaseSiteModules/tram-min.js"() {
                ...
                window.tram = (function (a) {
                    ...
                    function i(a2, b2, c2) {
                        ...
                        var d2 = c2;
                        return (
                            $.test(a2) || !_.test(a2) ? (d2 = parseInt(a2, 10)) : _.test(a2) && (d2 = 1e3 * parseFloat(a2)),
                            0 > d2 && (d2 = 0),
                            d2 === d2 ? d2 : c2
                        );
                    }
                                ...
                                function (a2, b2, c2, d2, e2) {
                                    return (
                                        ...
                                        (a2 /= d2 / 2) < 1
                                            ...
                                            : (c2 / 2) * ((a2 -= 2) * a2 * (((e2 *= 1.525) + 1) * a2 + e2) + 2) + b2
                                    );
                                },
                            ],
                        },
                        ...
                        L = l(function (b2) {
                            ...
                            function e2(a2, b3, c2) {
                                if (a2) {
                                    var e3 = typeof a2;
                                    if (
                                        (b3 || (this.timer && this.timer.destroy(), (this.queue = []), (this.active = false)),
                                        "number" == e3 && b3)
                                    )
                                        return (
                                            (this.timer = new S({
                            ...
                            function t2() {
                                ...
                                (c2 = c2.join(",")),
                                    this.style !== c2 && ((this.style = c2), (this.el.style[G.transition.dom] = c2));
                            }
                            function u2(a2, b3, e3) {
                                ...
                                for (f3 in a2)
                                    (h3 = a2[f3]),
                                        f3 in Z
                                            ? (k2.transform || (k2.transform = {}), (k2.transform[f3] = h3))
                                            : (s.test(f3) && (f3 = c(f3)), f3 in Y ? (k2[f3] = h3) : (i2 || (i2 = {}), (i2[f3] = h3)));
                                for (f3 in k2) {
                            ...
                            (a2.init = function (a3, b3, d3, e2) {
                                ...
                                (a2.stop = function () {
                                    (this.active || this.nextStyle) &&
                                        ((this.active = false), (this.nextStyle = null), V(this.el, this.name, this.get()));
                                    var a3 = this.tween;
                                        ...
                                        c2.call(this, a3, function (a4, c3, e2) {
                                            (d2[a4] = c3),
                                                void 0 === this.current[a4] &&
                                                    ((b3 = 0), ~a4.indexOf("scale") && (b3 = 1), (this.current[a4] = this.convert(b3, e2)));
                                        }),
                                        d2
                                    );
                                });
                        ...
                        T = l(R, function (a2, b2) {
                            (a2.init = function (a3) {
                                ...
                                (a2.render = function (a3) {
                                    ...
                                    for (b3 = d2; b3--; )
                                        (c2 = this.tweens[b3]),
                                            c2.context && (c2.render(a3), (this.current[c2.name] = c2.value), (e2 = true));
                        ...
                        function isPolyfilledFocusEvent(e) {
                            ...
                            return (
                                ...
                                (!/^(button|input|textarea|select|a)$/i.test(tag) &&
                                    !Number.isNaN(Number.parseFloat(el.tabIndex))) ||
                                /^audio$/i.test(tag) ||
                        ...
                        if (typeof reducer(void 0, { type }) === "undefined") {
                            throw new Error(
                                'Reducer "' +
                                    ...
                                    ("Don't try to handle " + _createStore.ActionTypes.INIT + ' or other actions in "redux/*" ') +
        ...
        var require_timm = __commonJS({
            "node_modules/timm/lib/timm.js"(exports) {
                ...
                function getIn2(obj, path) {
                    !Array.isArray(path) &&
                        throwStr(false ? "A path array should be provided when calling getIn()" : INVALID_ARGS);
                ...
                function doSetIn(obj, path, val, idx) {
                    ...
                    if (idx === path.length - 1) {
                        ...
                        var nestedObj =
                            isObject(obj) && isObject(obj[key]) ? obj[key] : typeof path[idx + 1] === "number" ? [] : {};
        ...
        function createElementState(state, ref, refType, elementId, actionItem) {
            const refId =
                refType === PLAIN_OBJECT2 ? (0, import_timm3.getIn)(actionItem, ["config", "target", "objectId"]) : null;
        ...
        var require_normalizeColor = __commonJS({
            "packages/systems/ix2/shared-utils/normalizeColor.js"(exports) {
                ...
                function normalizeColor2(inputColor) {
                    ...
                    const namedColor =
                        typeof colorNamesObj[rawColor] === "string" ? colorNamesObj[rawColor].toLowerCase() : null;
        ...
        var require_plugins = __commonJS({
            "packages/systems/ix2/plugins/index.js"(exports) {
                ...
                var pluginMethodMap2 = (exports.pluginMethodMap = new Map([
                    [
                ...
                if (finalSelector) {
                    if (useEventTarget === PARENT2) {
                        return queryDocument2(finalSelector).filter((parentElement) =>
                            eventTargets.some((targetElement) => elementContains2(parentElement, targetElement))
                        );
                    }
                    if (useEventTarget === CHILDREN2) {
                        return queryDocument2(finalSelector).filter((childElement) =>
                            eventTargets.some((targetElement) => elementContains2(targetElement, childElement))
                        );
                    }
                    if (useEventTarget === SIBLINGS2) {
                        return queryDocument2(finalSelector).filter((siblingElement) =>
                            eventTargets.some((targetElement) => isSiblingNode2(targetElement, siblingElement))
                        );
                    }
                }
                return eventTargets;
        ...
        function getInstanceOrigin(element, refState2 = {}, computedStyle = {}, actionItem, elementApi) {
            ...
            switch (actionItem.actionTypeId) {
                ...
                case TRANSFORM_SKEW2: {
                    return refState2[actionItem.actionTypeId] || transformDefaults[actionItem.actionTypeId];
                }
                case STYLE_FILTER2:
                    return getFilterDefaults(refState2[actionItem.actionTypeId], actionItem.config.filters);
                case STYLE_FONT_VARIATION2:
                    return getFontVariationDefaults(refState2[actionItem.actionTypeId], actionItem.config.fontVariations);
                case STYLE_OPACITY:
                    return {
        ...
        function hasDefined3dTransform({ actionTypeId }, { xValue, yValue, zValue }) {
            return (
                (actionTypeId === TRANSFORM_MOVE2 && zValue !== void 0) ||
                (actionTypeId === TRANSFORM_SCALE2 && zValue !== void 0) ||
        ...
        function shouldNamespaceEventParameter(eventTypeId, { basedOn }) {
            return (
                ...
                (eventTypeId === EventTypeConsts.MOUSE_MOVE && basedOn === EventBasedOn.ELEMENT)
            );
        }
                    ...
                    fontVariations.reduce((result, fontVariation) => {
                        if (result[fontVariation.type] == null) {
                            result[fontVariation.type] =
                                fontVariationDefaults[fontVariation.type] || fontVariation.defaultValue || 0;
                        }
                        return result;
                    }, actionState || {});
                    ...
                    switch (action.type) {
                        ...
                        case IX2_INSTANCE_ADDED3: {
                            ...
                            const destinationKeys = Object.keys(destination).filter(
                                (key) => destination[key] != null && typeof destination[key] !== "string"
                            );
        ...
        function queryDocument(baseSelector, descendantSelector) {
            return Array.prototype.slice.call(
                document.querySelectorAll(descendantSelector ? baseSelector + " " + descendantSelector : baseSelector)
            );
        }
        ...
        var init_IX2VanillaEvents = __esm({
            "packages/systems/ix2/engine/logic/IX2VanillaEvents.ts"() {
                ...
                whenComponentActiveChange = (handler) => (options, oldState) => {
                ...
                whenScrollDirectionChange =
                    ...
                    (options, oldState = {}) => {
                        ...
                        const scrollTopPadding =
                            (isPX ? scrollOffsetValue : (innerHeight * (scrollOffsetValue || 0)) / 100) / scrollHeightBounds;
                        let scrollingDown;
                ...
                pointIntersects = (point, rect) =>
                    point.left > rect.left && point.left < rect.right && point.top > rect.top && point.top < rect.bottom;
                ...
                IX2VanillaEvents_default = {
                    ...
                    [MOUSE_MOVE]: {
                        ...
                        handler: (
                            ...
                            if (basedOn !== EventBasedOn.ELEMENT || elementHovered || elementHovered !== state.elementHovered) {
        ...
        function createGroupInstances({
            ...
            const eventElementRoot =
                ixSession2.hasBoundaryNodes && eventTarget ? getClosestElement(eventTarget, BOUNDARY_SELECTOR2) : null;
            continuousActionGroups.forEach((actionGroup) => {
        ...
        function startActionGroup({
            ...
            const instanceDelay =
                isFirstGroup && isQuickEffect(event.action?.actionTypeId) ? event.config.delay : void 0;
        ...
        function createInstance(options) {
            ...
            const skipMotion = ixSession2.reducedMotion && ReducedMotionTypes[actionItem.actionTypeId];
            let skipToValue;
        ...
        var init_IX2VanillaEngine = __esm({
            "packages/systems/ix2/engine/logic/IX2VanillaEngine.ts"() {
                ...
                mapFoundValues = (object, iteratee) =>
                    (0, import_omitBy.default)((0, import_mapValues.default)(object, iteratee), import_isEmpty.default);
                ...
                Webflow.define(
                    ...
                    (module.exports = function ($, _) {
                        ...
                        function select(link) {
                            ...
                            var match =
                                tempLink.href === location.href || href === slug || (indexPage.test(href) && dirList.test(slug));
                ...
                Webflow.define(
                    ...
                    (module.exports = function ($) {
                        ...
                        function reducedMotionEnabled() {
                            return (
                                document.body.getAttribute("data-wf-scroll-motion") === "none" || reducedMotionMediaQuery.matches
                            );
                        }
                    ...
                    (module.exports = function ($, _) {
                        ...
                        function addListeners() {
                            ...
                            $doc.on("change", namespace + ` form input[type="radio"]`, (evt) => {
                                $(`input[name="${evt.target.name}"]:not(${CHECKBOX_CLASS_NAME})`).map((i, el) =>
                            ...
                            CUSTOM_CONTROLS.forEach(([controlType, customControlClassName]) => {
                                $doc.on(
                                    "focus",
                                    namespace + ` form input[type="${controlType}"]:not(` + customControlClassName + ")",
                                    (evt) => {
            ...
            "packages/shared/render/plugins/Lightbox/webflow-lightbox.js"(exports, module) {
                ...
                function createLightbox(window2, document2, $, container) {
                    ...
                    function lightbox(thing, index) {
                        ...
                        tram(removeClass($refs.lightbox, "hide").trigger("focus")).add("opacity .3s").start({
                            opacity: 1,
                        });
